    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-20">
          <div className="absolute inset-0 bg-white/5 bg-[linear-gradient(45deg,transparent_35%,rgba(255,255,255,.05)_35%,rgba(255,255,255,.05)_65%,transparent_65%,transparent),linear-gradient(-45deg,transparent_35%,rgba(255,255,255,.05)_35%,rgba(255,255,255,.05)_65%,transparent_65%,transparent)] bg-[length:60px_60px]"></div>
        </div>
