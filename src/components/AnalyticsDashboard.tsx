...
import { BarChart, Flame, Award, Clock, TrendingUp, Star, Info, TrendingDown, ArrowUp, ArrowDown, Target, BookOpen, BarChart3, Zap, Calendar, Trophy, Medal, Brain, CheckCircle, Timer, Lightbulb, Shield, Settings, FileText, Sparkles } from 'lucide-react';
    ...
    <div className="w-full space-y-6">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                            ...
                            <TooltipTrigger asChild>
                              ...
                              >
                                <div className="flex flex-col items-center text-center space-y-2">
                                  ...
                                  <div>
                                    <div className={`text-xs font-semibold ${achievement.unlocked ? "text-slate-800" : "text-slate-400"}`}>
                                      {achievement.label}
                                    </div>
                                    {achievement.unlocked && (
                                      <div className="w-1 h-1 rounded-full bg-green-400 mx-auto mt-1"></div>
                                    )}
                                  </div>
                                </div>
                              </div>
        ...
        <TabsContent value="export" className="mt-6">
          <ExportCapabilities analyticsData={analyticsData} />
        </TabsContent>
      </Tabs>
    </div>
  );
